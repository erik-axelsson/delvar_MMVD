...
foreach $chr (@chromosomes) {
    $run_dir = "/proj/b2013119/nobackup/private/160DG_GenomeSTRIP/SVGenotyper/$chr/";
    mkdir $run_dir;
    $run_dir = "/proj/b2013119/nobackup/private/160DG_GenomeSTRIP/SVGenotyper/$chr/$name/";
    mkdir $run_dir;
#    $run_dir = "/proj/b2013119/private/GenomeSTRIP/SVGenotyper/$chr/$name/";
#    mkdir $run_dir;
#    $run_run_dir = "/proj/b2013119/private/GenomeSTRIP/SVGenotyper/$chr/$name/Rundir/";
#    mkdir $run_run_dir;
    $pre_processing_dir = "/proj/b2013119/nobackup/private/160DG_GenomeSTRIP/SVPreprocess/$chr/";
    $discovery_dir = "/proj/b2013119/nobackup/private/160DG_GenomeSTRIP/SVDiscovery/$chr/$name/";
    ...
    $SVP_file = $run_dir.$chr."_SVGenotyper.sh";
    system "rm $SVP_file";
    $log_file = $SVP_file.".log";
    $genotyped_vcf = $run_dir.$chr.".dels.genotypes.vcf";
    $discovery_vcf = $discovery_dir.$chr."_".$name.".SVDiscovery.vcf";
